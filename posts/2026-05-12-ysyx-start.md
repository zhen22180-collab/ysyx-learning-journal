...
我准备把“一生一芯”作为接下来一段时间的主线项目，用它连接计算机系统、处理器设计、操作系统和硬件/软件协同设计。这个博客会记录每一周的学习证据：读过什么、实现了什么、哪里失败、如何验证。
...
1. 搭建开发环境，记录可复现命令。
2. 阅读官方项目介绍和课程文档，整理术语表。
3. 建立每周日志模板，固定输出问题、实验、证据、下一步。
4. 开始准备英文项目 README 和技术摘要。
